...
const navItems=(
  ...
  return (
    ...
    mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50
  ...
  <div className="navbar-center hidden lg:flex">
    <ul className="menu menu-horizontal px-1">
      ...
      {navItems}
      <label className="  flex items-center gap-2 py-2 px-3 border rounded-md ">
  ...
  </div>
 {
  ...
  <a className="bg-black px-3 py-2 cursor-pointer text-white 
  rounded-md hover:bg-slate-800 duration-300"
