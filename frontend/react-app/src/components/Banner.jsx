...
const Banner = () => {
    ...
    <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-6">
        ...
        <h1 className="text-4xl font-bold">Hello welcome here to learn something 
            ...
            <p className="text-xl">
                ...
                Sint quas nesciunt ut illum. Blanditiis, esse et. Deleniti laborum voluptates
                 quod sit quibusdam id, eaque velit quidem. Nulla, placeat quam? Modi.
            </p>
  ...
  <input type="text" className="grow" placeholder="Email" />
        ...
        <div className="w-full md:w-1/2 order-1"><img src={banner} alt="" /></div>
    </div>
    </>
  )
}
